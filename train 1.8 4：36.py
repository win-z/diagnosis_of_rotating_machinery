...
class Train(object):
    ...
    def datashape(self):
        ...
        cw_matdata2=io.loadmat('sets_CWRUdata2')
        ...
        self.cw2_x_train = (cw_matdata2['x_train'][perm0])[0:self.ltrain_size]
        ...
        self.cw2_y_train = (cw_matdata2['y_train'][perm0])[0:self.ltrain_size]
        ...
        self.cw2_x_test = (cw_matdata2['x_test'][perm1])[0:self.test_size]
        self.cw2_y_test = (cw_matdata2['y_test'][perm1])[0:self.test_size]
    ...
    def build_model(self):
        ...
        #self.d_loss = (s_l_r - d_loss_f)*(1-self.flag) + s_l_r*self.flag*10 + d_regular
        #self.g_loss = d_loss_f*(1-self.flag) + 0.01*f_match
        
        self.d_loss = s_l_r*self.flag
        self.g_loss = (d_loss_f + 0.01*f_match)*(1-self.flag)
    ...
    def train(self):
        ...
        for epoch in range(self.EPOCH):
            ...
            for idx in range(iters):
                ...
                batchx, batchl = mnist.train.next_batch(self.batch_size,self.cw2_x_train,self.cw2_y_train,test=2)
...
# output = conv2d('Z_cona{}'.format(i), output, 3, 64, stride=1, padding='SAME')
    ...
    def generator(self,name, noise, reuse):
        with tf.variable_scope(name,reuse=reuse):
            ...
            output = tf.image.resize_images(output, (32, 32))
            # output = tf.nn.relu(self.bn('g_bn4', output))
    ...
    def test(self):
        ...
        for i in range(self.test_size//self.batch_size):
            testx, testl = self.cw2_x_test[i*self.batch_size:(i+1)*self.batch_size],self.cw2_y_test[i*self.batch_size:(i+1)*self.batch_size]  #读测试集的输入和标签
